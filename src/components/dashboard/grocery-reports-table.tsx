...
export function GroceryReportsTable({ matrix }: { matrix: GroceryReportMatrix }) {
          ...
          {matrix.rows.map((row) => (
            ...
            >
              ...
              {matrix.columns.map((col) => {
                ...
                const isSpesaTotal = col === "Spesa Total";
                const isTotalProfit = col === "Total Profit";
                const showAlways = isTotalProfit || isTotalSale || isSpesaTotal;
                return (
                  <td
                    key={col}
                    className={cn(
                      ...
                      isSpesaTotal && "font-semibold text-[var(--lv-muted-strong)]",
